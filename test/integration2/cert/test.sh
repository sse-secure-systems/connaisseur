...
certificate_check() {
    EXPT_KEY=$(yq e ".kubernetes.deployment.tls.key" test/integration2/cert/update.yaml)
    ...
    EXPT_CRT=$(yq e ".kubernetes.deployment.tls.cert" test/integration2/cert/update.yaml)
