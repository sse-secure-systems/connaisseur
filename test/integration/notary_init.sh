...
spawn notary init docker.io/securesystemsengineering/testimage --publish -c ./test/integration/notary_service_container/config/client_config.json -s https://notary.server:4443 -D
