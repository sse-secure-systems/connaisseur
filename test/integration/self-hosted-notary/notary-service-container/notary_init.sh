...
spawn notary init docker.io/securesystemsengineering/testimage --publish -c ./test/integration/self-hosted-notary/notary-service-container/client_config.json -s https://notary.server:4443 -D
